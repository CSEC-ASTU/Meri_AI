...
export default function Home() {
  ...
  const renderContent = () => {
    switch (currentRoute) {
      ...
      case AppRoute.MAP:
        return (
          <main className="flex-grow pt-28 max-w-7xl mx-auto px-4 lg:px-8 pb-14 animate-in slide-in-from-bottom-4 duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              <div className="lg:col-span-8 h-[520px] lg:h-[720px] rounded-3xl overflow-hidden bg-white border border-slate-200 shadow-xl">
                <MapWrapper selectedNodeId={selectedDestId} />
              </div>

              <div className="lg:col-span-4 h-full rounded-3xl bg-white border border-slate-200 shadow-xl">
                <AIAssistant />
              </div>
            </div>
          </main>
